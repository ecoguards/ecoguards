      ...
      <section className="md:flex md:justify-between md:py-2 h-full">
          ...
          <div className="border rounded-md h-80">
            ...
            <div className="border-b flex items-center justify-between px-3 md:h-16">
              <div className="flex w-[60%] items-center ">
                <img
                  alt=""
                  className="w-10 h-10 mr-2 border rounded-full dark:bg-gray-500 dark:border-gray-700"
                  src="https://source.unsplash.com/40x40/?portrait?1"
                />
                <p className="text-white font-semibold">
                  Wade Warren{" "}
                  <span className="font-light text-sm">Donated</span> <br />{" "}
                  <span className="font-light text-sm">Today; 8:00am</span>
                </p>
              </div>
        ...
        <div className="md:w-[45%] w-full text-white md:mt-0 mt-5">
          <div>
            ...
            <p className="mb-3">
              HornShield is a dedicated initiative aimed at safeguarding black
              rhinos from the threats of poaching and habitat loss. The project
              employs a two-fold approach, focusing on implementing robust
              security measures and supporting habitat restoration efforts. By
              combining these strategies, HornShield aims to ensure the
              long-term survival and well-being of black rhino populations.
            </p>
            ...
            <div className="border rounded-md p-5 backdrop-blur-lg bg-gradient-to-r from-zinc-500 to-zinc-600">
              ...
              <div className="flex justify-center w-full">
                <Link to="/donate">
                  <button className="text-white font-bold w-full bg-orange-300 rounded-lg py-3 px-10">
                    Donate
                  </button>
                </Link>
              </div>
          ...
          <ul className="mb-10 pl-10">
            <li className="mb-3 text-base list-disc">
              <span className="font-bold">Enhanced Security: </span>HornShield
              works to establish and strengthen security measures, including
              anti-poaching patrols, surveillance systems, and ranger training
              programs. These measures aim to deter poachers and protect black
              rhinos from illegal hunting.
            </li>
            <li className="mb-3 text-base list-disc">
              <span className="font-bold">Community Engagement: </span>The
              project recognizes the vital role of local communities in rhino
              conservation. HornShield fosters partnerships with communities
              living near rhino habitats, promoting awareness, education, and
              economic opportunities that incentivize the protection of black
              rhinos.
            </li>
          </ul>
          ...
          <ul className="pl-10">
            <li className="mb-3 text-base list-disc">
              <span className="font-bold">Ecosystem Preservation: </span>
              HornShield focuses on restoring and preserving the natural
              habitats of black rhinos. This involves initiatives such as
              reforestation, invasive species management, and habitat
              connectivity enhancements to create sustainable environments for
              rhinos to thrive.
            </li>
            <li className="mb-3 text-base list-disc">
              <span className="font-bold">Conservation Research: </span>The
              project invests in scientific research to better understand the
              ecological needs of black rhinos. This knowledge informs habitat
              restoration efforts and ensures the conservation strategies
              implemented align with the specific requirements of the species.
            </li>
          </ul>
        </div>
      </section>
